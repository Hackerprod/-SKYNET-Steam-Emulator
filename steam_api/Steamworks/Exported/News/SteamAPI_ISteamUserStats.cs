...
//        [DllExport(CallingConvention = CallingConvention.Cdecl)]
//        public static bool SteamAPI_ISteamUserStats_GetStat(string pchName, ref int pData)
//        {
...
//        [DllExport(CallingConvention = CallingConvention.Cdecl)]
//        public static SteamAPICall_t SteamAPI_ISteamUserStats_RequestUserStats(ulong steamIDUser)
//        {
...
//        [DllExport(CallingConvention = CallingConvention.Cdecl)]
//        public static SteamAPICall_t SteamAPI_ISteamUserStats_FindOrCreateLeaderboard(string pchLeaderboardName, int eLeaderboardSortMethod, int eLeaderboardDisplayType)
//        {
...
//        [DllExport(CallingConvention = CallingConvention.Cdecl)]
//        public static SteamAPICall_t SteamAPI_ISteamUserStats_DownloadLeaderboardEntries(ulong hSteamLeaderboard, IntPtr eLeaderboardDataRequest, int nRangeStart, int nRangeEnd)
//        {
...
//        [DllExport(CallingConvention = CallingConvention.Cdecl)]
//        public static SteamAPICall_t SteamAPI_ISteamUserStats_DownloadLeaderboardEntriesForUsers(ulong hSteamLeaderboard, ulong prgUsers, int cUsers)
//        {
...
//        [DllExport(CallingConvention = CallingConvention.Cdecl)]
//        public static SteamAPICall_t SteamAPI_ISteamUserStats_UploadLeaderboardScore(ulong hSteamLeaderboard, int eLeaderboardUploadScoreMethod, uint nScore, uint pScoreDetails, int cScoreDetailsCount)
//        {
...
//        [DllExport(CallingConvention = CallingConvention.Cdecl)]
//        public static SteamAPICall_t SteamAPI_ISteamUserStats_AttachLeaderboardUGC(ulong hSteamLeaderboard, ulong hUGC)
//        {
...
//        {
//            SteamEmulator.Write("SteamAPI_ISteamUserStats", msg);
//        }
//    }
//}
