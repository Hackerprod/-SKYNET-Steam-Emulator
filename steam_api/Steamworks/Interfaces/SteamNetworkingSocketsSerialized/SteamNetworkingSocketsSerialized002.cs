...
{
    [Interface("SteamNetworkingSocketsSerialized002")]
    public class SteamNetworkingSocketsSerialized002 : ISteamInterface
    {
        ...
        public int GetNetworkConfigJSON(IntPtr _, IntPtr buf, uint cbBuf)
        {
