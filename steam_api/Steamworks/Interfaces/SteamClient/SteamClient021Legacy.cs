...
namespace SKYNET.Steamworks.Interfaces
{
    ...
    public class SteamClient021Legacy : ISteamInterface
    {
        ...
        public void SetLocalIPBinding(IntPtr _, IntPtr unIP, ushort usPort) => SteamEmulator.SteamClient.SetLocalIPBinding(unIP, usPort);
