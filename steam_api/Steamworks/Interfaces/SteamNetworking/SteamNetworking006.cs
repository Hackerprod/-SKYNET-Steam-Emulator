...
namespace SKYNET.Steamworks.Interfaces
{
    ...
    public class SteamNetworking006 : ISteamInterface
    {
        ...
        public uint CreateListenSocket(IntPtr _, int nVirtualP2PPort, SteamIPAddress_t nIP, ushort nPort, bool bAllowUseOfPacketRelay)
        {
        ...
        public uint CreateConnectionSocket(IntPtr _, SteamIPAddress_t nIP, ushort nPort, int nTimeoutSec)
        {
