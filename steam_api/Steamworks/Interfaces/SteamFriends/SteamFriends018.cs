...
{
    [Interface("SteamFriends018")]
    public class SteamFriends018 : ISteamInterface
    {
        public string GetPersonaName(IntPtr _) { return SteamFriends.Instance.GetPersonaName(); }
        public SteamAPICall_t SetPersonaName(IntPtr _, string name) { return SteamFriends.Instance.SetPersonaName(name); }
        ...
        public CSteamID GetFriendByIndex(IntPtr _, int iFriend, int iFriendFlags) { return SteamFriends.Instance.GetFriendByIndex(iFriend, iFriendFlags); }
        ...
        public string GetFriendPersonaName(IntPtr _, ulong steamID) { return SteamFriends.Instance.GetFriendPersonaName(steamID); }
        ...
        public string GetFriendPersonaNameHistory(IntPtr _, ulong steamID, int index) { return SteamFriends.Instance.GetFriendPersonaNameHistory(steamID, index); }
        public int GetFriendSteamLevel(IntPtr _, ulong steamID) { return SteamFriends.Instance.GetFriendSteamLevel(steamID); }
        public string GetPlayerNickname(IntPtr _, ulong steamID) { return SteamFriends.Instance.GetPlayerNickname(steamID); }
        ...
        public string GetFriendsGroupName(IntPtr _, FriendsGroupID_t friendsGroupID) { return SteamFriends.Instance.GetFriendsGroupName(friendsGroupID); }
        ...
        public void GetFriendsGroupMembersList(IntPtr _, FriendsGroupID_t friendsGroupID, ref ulong[] pOutSteamIDMembers, int nMembersCount) { SteamFriends.Instance.GetFriendsGroupMembersList(friendsGroupID, ref pOutSteamIDMembers, nMembersCount); }
        ...
        public CSteamID GetClanByIndex(IntPtr _, int iClan) { return SteamFriends.Instance.GetClanByIndex(iClan); }
        public string GetClanName(IntPtr _, ulong steamIDClan) { return SteamFriends.Instance.GetClanName(steamIDClan); }
        public string GetClanTag(IntPtr _, ulong steamIDClan) { return SteamFriends.Instance.GetClanTag(steamIDClan); }
        ...
        public CSteamID GetFriendFromSourceByIndex(IntPtr _, ulong steamIDSource, int iFriend) { return SteamFriends.Instance.GetFriendFromSourceByIndex(steamIDSource, iFriend); }
        ...
        public CSteamID GetClanOwner(IntPtr _, ulong steamIDClan) { return SteamFriends.Instance.GetClanOwner(steamIDClan); }
        public int GetClanOfficerCount(IntPtr _, ulong steamIDClan) { return SteamFriends.Instance.GetClanOfficerCount(steamIDClan); }
        public CSteamID GetClanOfficerByIndex(IntPtr _, ulong steamIDClan, int iOfficer) { return SteamFriends.Instance.GetClanOfficerByIndex(steamIDClan, iOfficer); }
        public uint GetUserRestrictions(IntPtr _) { return SteamFriends.Instance.GetUserRestrictions(); }
        ...
        public string GetFriendRichPresence(IntPtr _, ulong steamIDFriend, string pchKey) { return SteamFriends.Instance.GetFriendRichPresence(steamIDFriend, pchKey); }
        ...
        public string GetFriendRichPresenceKeyByIndex(IntPtr _, ulong steamIDFriend, int iKey) { return SteamFriends.Instance.GetFriendRichPresenceKeyByIndex(steamIDFriend, iKey); }
        ...
        public CSteamID GetCoplayFriend(IntPtr _, int iCoplayFriend) { return SteamFriends.Instance.GetCoplayFriend(iCoplayFriend); }
        ...
        public CSteamID GetChatMemberByIndex(IntPtr _, ulong steamIDClan, int iUser) { return SteamFriends.Instance.GetChatMemberByIndex(steamIDClan, iUser); }
        ...
        public int GetClanChatMessage(IntPtr _, ulong steamIDClanChat, int iMessage, IntPtr prgchText, int cchTextMax, int peChatEntryType, ref ulong[] psteamidChatter) { return SteamFriends.Instance.GetClanChatMessage(steamIDClanChat, iMessage, prgchText, cchTextMax, peChatEntryType, ref psteamidChatter); }
        ...
        public int GetFriendMessage(IntPtr _, ulong steamIDFriend, int iMessageID, IntPtr pvData, int cubData, ref int peChatEntryType) { return SteamFriends.Instance.GetFriendMessage(steamIDFriend, iMessageID, pvData, cubData, peChatEntryType); }
        ...
        public string GetProfileItemPropertyString(IntPtr _, ulong steamID, int itemType, int prop) { return SteamFriends.Instance.GetProfileItemPropertyString(steamID, itemType, prop); }
