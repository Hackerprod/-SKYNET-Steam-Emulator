...
public class SteamAPI_ISteamUtils : BaseCalls
{
    ...
    public static uint SteamAPI_ISteamUtils_GetSecondsSinceAppActive()
    {
        ...
        return SteamEmulator.SteamUtils.GetSecondsSinceAppActive(SteamEmulator.SteamUtils.BaseAddress);
    }
    ...
    public static uint SteamAPI_ISteamUtils_GetSecondsSinceComputerActive()
    {
        ...
        return SteamEmulator.SteamUtils.GetSecondsSinceComputerActive(SteamEmulator.SteamUtils.BaseAddress);
    }
    ...
    public static EUniverse SteamAPI_ISteamUtils_GetConnectedUniverse()
    {
        ...
        return SteamEmulator.SteamUtils.GetConnectedUniverse(SteamEmulator.SteamUtils.BaseAddress);
    }
    ...
    public static uint SteamAPI_ISteamUtils_GetServerRealTime()
    {
        ...
        return SteamEmulator.SteamUtils.GetServerRealTime(SteamEmulator.SteamUtils.BaseAddress);
    }
    ...
    public static string SteamAPI_ISteamUtils_GetIPCountry()
    {
        ...
        return SteamEmulator.SteamUtils.GetIPCountry(SteamEmulator.SteamUtils.BaseAddress);
    }
    ...
    public static bool SteamAPI_ISteamUtils_GetImageSize(int iImage, uint pnWidth, uint pnHeight)
    {
        ...
        return SteamEmulator.SteamUtils.GetImageSize(SteamEmulator.SteamUtils.BaseAddress, iImage, pnWidth, pnHeight);
    }
    ...
    public static bool SteamAPI_ISteamUtils_GetImageRGBA(int iImage, uint pubDest, int nDestBufferSize)
    {
        ...
        return SteamEmulator.SteamUtils.GetImageRGBA(SteamEmulator.SteamUtils.BaseAddress, iImage, pubDest, nDestBufferSize);
    }
    ...
    public static bool SteamAPI_ISteamUtils_GetCSERIPPort(uint unIP, uint usPort)
    {
        ...
        return SteamEmulator.SteamUtils.GetCSERIPPort(SteamEmulator.SteamUtils.BaseAddress, unIP, usPort);
    }
    ...
    public static uint SteamAPI_ISteamUtils_GetCurrentBatteryPower()
    {
        ...
        return SteamEmulator.SteamUtils.GetCurrentBatteryPower(SteamEmulator.SteamUtils.BaseAddress);
    }
    ...
    public static uint SteamAPI_ISteamUtils_GetAppID()
    {
        ...
        return SteamEmulator.SteamUtils.GetAppID(SteamEmulator.SteamUtils.BaseAddress);
    }
    ...
    public static bool SteamAPI_ISteamUtils_IsAPICallCompleted(SteamAPICall_t hSteamAPICall, bool pbFailed)
    {
        ...
        return SteamEmulator.SteamUtils.IsAPICallCompleted(SteamEmulator.SteamUtils.BaseAddress, hSteamAPICall, pbFailed);
    }
    ...
    public static ESteamAPICallFailure SteamAPI_ISteamUtils_GetAPICallFailureReason(SteamAPICall_t hSteamAPICall)
    {
        ...
        return SteamEmulator.SteamUtils.GetAPICallFailureReason(SteamEmulator.SteamUtils.BaseAddress, hSteamAPICall);
    }
    ...
    public static bool SteamAPI_ISteamUtils_GetAPICallResult(SteamAPICall_t hSteamAPICall, IntPtr pCallback, int cubCallback, int iCallbackExpected, bool pbFailed)
    {
        ...
        return SteamEmulator.SteamUtils.GetAPICallResult(SteamEmulator.SteamUtils.BaseAddress, hSteamAPICall, pCallback, cubCallback, iCallbackExpected, pbFailed);
    }
    ...
    public static uint SteamAPI_ISteamUtils_GetIPCCallCount()
    {
        ...
        return SteamEmulator.SteamUtils.GetIPCCallCount(SteamEmulator.SteamUtils.BaseAddress);
    }
    ...
    public static bool SteamAPI_ISteamUtils_IsOverlayEnabled()
    {
        ...
        return SteamEmulator.SteamUtils.IsOverlayEnabled(SteamEmulator.SteamUtils.BaseAddress);
    }
    ...
    public static bool SteamAPI_ISteamUtils_BOverlayNeedsPresent()
    {
        ...
        return SteamEmulator.SteamUtils.BOverlayNeedsPresent(SteamEmulator.SteamUtils.BaseAddress);
    }
    ...
    public static SteamAPICall_t SteamAPI_ISteamUtils_CheckFileSignature(string szFileName)
    {
        ...
        return SteamEmulator.SteamUtils.CheckFileSignature(SteamEmulator.SteamUtils.BaseAddress, szFileName);
    }
    ...
    public static bool SteamAPI_ISteamUtils_ShowGamepadTextInput(EGamepadTextInputMode eInputMode, EGamepadTextInputLineMode eLineInputMode, string pchDescription, uint unCharMax, string pchExistingText)
    {
        ...
        return SteamEmulator.SteamUtils.ShowGamepadTextInput(SteamEmulator.SteamUtils.BaseAddress, eInputMode, eLineInputMode, pchDescription, unCharMax, pchExistingText);
    }
    ...
    public static uint SteamAPI_ISteamUtils_GetEnteredGamepadTextLength()
    {
        ...
        return SteamEmulator.SteamUtils.GetEnteredGamepadTextLength(SteamEmulator.SteamUtils.BaseAddress);
    }
    ...
    public static bool SteamAPI_ISteamUtils_GetEnteredGamepadTextInput(string pchText, uint cchText)
    {
        ...
        return SteamEmulator.SteamUtils.GetEnteredGamepadTextInput(SteamEmulator.SteamUtils.BaseAddress, pchText, cchText);
    }
    ...
    public static string SteamAPI_ISteamUtils_GetSteamUILanguage()
    {
        ...
        return SteamEmulator.SteamUtils.GetSteamUILanguage(SteamEmulator.SteamUtils.BaseAddress);
    }
    ...
    public static bool SteamAPI_ISteamUtils_IsSteamRunningInVR()
    {
        ...
        return SteamEmulator.SteamUtils.IsSteamRunningInVR(SteamEmulator.SteamUtils.BaseAddress);
    }
    ...
    public static bool SteamAPI_ISteamUtils_IsSteamInBigPictureMode()
    {
        ...
        return SteamEmulator.SteamUtils.IsSteamInBigPictureMode(SteamEmulator.SteamUtils.BaseAddress);
    }
    ...
    public static bool SteamAPI_ISteamUtils_IsVRHeadsetStreamingEnabled()
    {
        ...
        return SteamEmulator.SteamUtils.IsVRHeadsetStreamingEnabled(SteamEmulator.SteamUtils.BaseAddress);
    }
    ...
    public static bool SteamAPI_ISteamUtils_IsSteamChinaLauncher()
    {
        ...
        return SteamEmulator.SteamUtils.IsSteamChinaLauncher(SteamEmulator.SteamUtils.BaseAddress);
    }
    ...
    public static bool SteamAPI_ISteamUtils_InitFilterText()
    {
        ...
        return SteamEmulator.SteamUtils.InitFilterText(SteamEmulator.SteamUtils.BaseAddress);
    }
    ...
    public static int SteamAPI_ISteamUtils_FilterText(string pchOutFilteredText, uint nByteSizeOutFilteredText, string pchInputMessage, bool bLegalOnly)
    {
        ...
        return SteamEmulator.SteamUtils.FilterText(SteamEmulator.SteamUtils.BaseAddress, pchOutFilteredText, nByteSizeOutFilteredText, pchInputMessage, bLegalOnly);
    }
    ...
    public static ESteamIPv6ConnectivityState SteamAPI_ISteamUtils_GetIPv6ConnectivityState(ESteamIPv6ConnectivityProtocol eProtocol)
    {
        ...
        return SteamEmulator.SteamUtils.GetIPv6ConnectivityState(SteamEmulator.SteamUtils.BaseAddress, eProtocol);
    }
