...
namespace SKYNET.Managers
{
    public class Steam_User : SteamInterface, ISteamUser
    {
        ...
        {
            PRINT_DEBUG($"{"SteamAPI_SteamUser_v021"}");
        ...
        {
            PRINT_DEBUG($"{"SteamAPI_SteamUser_v020"}");
        ...
        {
            PRINT_DEBUG($"{"SteamAPI_ISteamUser_GetHSteamUser"}");
        ...
        {
            PRINT_DEBUG($"{"SteamAPI_ISteamUser_BLoggedOn"}");
            return true;
        }
        ...
        {
            PRINT_DEBUG($"{"SteamAPI_ISteamUser_InitiateGameConnection"}");
            return 1;
        }
        ...
        {
            PRINT_DEBUG($"{"SteamAPI_ISteamUser_TerminateGameConnection"}");
        }
        ...
        {
            PRINT_DEBUG($"{"SteamAPI_ISteamUser_StartVoiceRecording"}");
        }

        [DllExport(CallingConvention = CallingConvention.Cdecl)]
        public static void SteamAPI_ISteamUser_StopVoiceRecording(ISteamUser self)
        {
            PRINT_DEBUG($"{"SteamAPI_ISteamUser_StopVoiceRecording"}");
        }
        ...
        {
            PRINT_DEBUG($"{"SteamAPI_ISteamUser_GetAvailableVoice"}");
        ...
        {
            PRINT_DEBUG($"{"SteamAPI_ISteamUser_GetVoice"}");
            return VoiceResult.NotInitialized;
        }
        ...
        {
            PRINT_DEBUG($"{"SteamAPI_ISteamUser_DecompressVoice"}");
            return VoiceResult.NotInitialized;
        }
        ...
        {
            PRINT_DEBUG($"{"SteamAPI_ISteamUser_GetVoiceOptimalSampleRate"}");
            return 10;
        }
        ...
        {
            PRINT_DEBUG($"{"SteamAPI_ISteamUser_GetAuthSessionTicket"}");
        ...
        {
            PRINT_DEBUG($"{"SteamAPI_ISteamUser_BeginAuthSession"}");
        ...
        {
            PRINT_DEBUG($"{"SteamAPI_ISteamUser_UserHasLicenseForApp"}");
        ...
        {
            PRINT_DEBUG($"{"SteamAPI_ISteamUser_BIsBehindNAT"}");
            return false;
        }
        ...
        {
            PRINT_DEBUG($"{"SteamAPI_ISteamUser_AdvertiseGame"}");
        }
        ...
        {
            PRINT_DEBUG($"{"SteamAPI_ISteamUser_RequestEncryptedAppTicket"}");
        ...
        {
            PRINT_DEBUG($"{"SteamAPI_ISteamUser_GetEncryptedAppTicket"}");
            return true;
        }
        ...
        {
            PRINT_DEBUG($"{"SteamAPI_ISteamUser_GetGameBadgeLevel"}");
            return 90;
        }
        ...
        {
            PRINT_DEBUG($"{"SteamAPI_ISteamUser_GetPlayerSteamLevel"}");
            return 100;
        }
        ...
        {
            PRINT_DEBUG($"{"SteamAPI_ISteamUser_RequestStoreAuthURL"}");
            return (SteamAPICall_t)1;
        }
        ...
        {
            PRINT_DEBUG($"{"SteamAPI_ISteamUser_BIsPhoneVerified"}");
            return true;
        }
        ...
        {
            PRINT_DEBUG($"{"SteamAPI_ISteamUser_BIsTwoFactorEnabled"}");
            return false;
        }
        ...
        {
            PRINT_DEBUG($"{"SteamAPI_ISteamUser_BIsPhoneIdentifying"}");
            return false;
        }
        ...
        {
            PRINT_DEBUG($"{"SteamAPI_ISteamUser_BIsPhoneRequiringVerification"}");
            return false;
        }
        ...
        {
            PRINT_DEBUG($"{"SteamAPI_ISteamUser_GetMarketEligibility"}");
            return (SteamAPICall_t)1;
        }
        ...
        {
            PRINT_DEBUG($"{"SteamAPI_ISteamUser_GetDurationControl"}");
            return (SteamAPICall_t)1;
        }
        ...
        {
            PRINT_DEBUG($"{"SteamAPI_ISteamUser_BSetDurationControlOnlineState"}");
            return true;
        }
