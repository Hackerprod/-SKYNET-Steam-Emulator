...
namespace SKYNET.GUI
{
    partial class frmMain
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.BT_Minimize = new SKYNET_MinimizeBox();
            this.BT_Close = new SKYNET_CloseBox();
            this.panel3 = new Panel();
            this.LB_Clear = new Label();
            this.LB_Browser = new Label();
            this.label6 = new Label();
            this.LB_Status = new Label();
            this.panel4 = new Panel();
            this.LB_Menu_NickName = new Label();
            this.label3 = new Label();
            this.label2 = new Label();
            this.PN_LeftContainer = new Panel();
            this.PN_GameContainer = new Panel();
            this.panel8 = new Panel();
            this.panel6 = new Panel();
            this.LB_Add = new Label();
            this.PB_Add = new PictureBox();
            this.panel1 = new Panel();
            this.TB_Search = new SKYNET_TextBox();
            this.panel7 = new Panel();
            this.pictureBox3 = new PictureBox();
            this.PB_Avatar = new SKYNET_CircularPictureBox();
            this.BT_Connect = new SKYNET_Button();
            this.BT_Profile = new SKYNET_Button();
            this.LB_SteamID = new Label();
            this.label9 = new Label();
            this.LB_NickName = new Label();
            ...
            this.PB_Banner = new PictureBox();
            this.PB_Logo = new PictureBox();
            this.LB_GameTittle = new SKYNET.GUI.Controls.SKYNET_Label();
            this.ShadowBox = new Panel();
            this.BT_GameAction = new SKYNET_Button();
            this.PN_BodyContainer = new Panel();
            this.WebLogger1 = new SKYNET_WebLogger();
            this.PN_UserContainer = new Panel();
            this.CM_MenuGame = new SKYNET_ContextMenuStrip();
            this.OpenMenuItem = new ToolStripMenuItem();
            this.OpenWithoutEmuMenuItem = new ToolStripMenuItem();
            this.OpenFileLocationMenuItem = new ToolStripMenuItem();
            this.RemoveMenuItem = new ToolStripMenuItem();
            this.ToTopMenuItem = new ToolStripMenuItem();
            this.ToButtomMenuItem = new ToolStripMenuItem();
            this.GameCacheMenuItem = new ToolStripMenuItem();
            this.ConfigureMenuItem = new ToolStripMenuItem();
            ...
            this.BT_Minimize.Dock = DockStyle.Right;
            ...
            this.LB_Clear.Cursor = Cursors.Hand;
            ...
            this.LB_Browser.Cursor = Cursors.Hand;
            ...
            this.LB_Menu_NickName.Cursor = Cursors.Hand;
            ...
            this.PN_GameContainer.Dock = DockStyle.Fill;
            ...
            this.PN_GameContainer.DragDrop += new DragEventHandler(this.PN_GameContainer_DragDrop);
            this.PN_GameContainer.DragEnter += new DragEventHandler(this.PN_GameContainer_DragEnter);
            // 
            // panel8
            // 
            ...
            this.LB_Add.MouseClick += new MouseEventHandler(this.AddGame_Clicked);
            this.LB_Add.MouseLeave += new System.EventHandler(this.Add_MouseLeave);
            this.LB_Add.MouseMove += new MouseEventHandler(this.Add_MouseMove);
            // 
            // PB_Add
            // 
            ...
            this.PB_Add.SizeMode = PictureBoxSizeMode.Zoom;
            this.PB_Add.TabIndex = 9;
            this.PB_Add.TabStop = false;
            this.PB_Add.MouseClick += new MouseEventHandler(this.AddGame_Clicked);
            this.PB_Add.MouseLeave += new System.EventHandler(this.Add_MouseLeave);
            this.PB_Add.MouseMove += new MouseEventHandler(this.Add_MouseMove);
            // 
            // panel1
            // 
            ...
            this.TB_Search.LogoCursor = Cursors.Default;
            ...
            this.TB_Search.TextAlign = HorizontalAlignment.Left;
            this.TB_Search.KeyUp += new KeyEventHandler(this.TB_Search_KeyUp);
            // 
            // panel7
            // 
            ...
            this.BT_Connect.Cursor = Cursors.Hand;
            ...
            this.BT_Profile.Cursor = Cursors.Hand;
            ...
            this.gradiantBox1.Dock = DockStyle.Top;
            ...
            this.gradiantBox1.Mode = Mode.Vertical;
            ...
            this.PB_Banner.Dock = DockStyle.Top;
            ...
            this.PB_Banner.SizeMode = PictureBoxSizeMode.StretchImage;
            ...
            this.ShadowBox.Dock = DockStyle.Bottom;
            ...
            this.BT_GameAction.Cursor = Cursors.Hand;
            ...
            this.WebLogger1.Dock = DockStyle.Fill;
            ...
            this.CM_MenuGame.Items.AddRange(new ToolStripItem[] {
            this.OpenMenuItem,
        ...
        private Label LB_Menu_NickName;
