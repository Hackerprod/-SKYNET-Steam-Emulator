...
namespace Steamworks
{
	internal unsafe class ISteamNetworkingMessages : SteamInterface
	{
		...
		private static extern ConnectionState _GetSessionConnectionInfo( IntPtr self, ref NetIdentity identityRemote, ref ConnectionInfo pConnectionInfo, ref SteamNetworkingQuickConnectionStatus pQuickStatus );
		
		#endregion
		internal ConnectionState GetSessionConnectionInfo( ref NetIdentity identityRemote, ref ConnectionInfo pConnectionInfo, ref SteamNetworkingQuickConnectionStatus pQuickStatus )
		{
